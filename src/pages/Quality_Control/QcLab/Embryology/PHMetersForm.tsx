  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", gap: "20px" }}>
      ...
      <div style={{ backgroundColor: "#fff", borderRadius: "12px", border: "1px solid #e5e7eb", padding: "24px" }}>
        ...
        {/* Parameters Grid - Fixed to 3 Columns to match Microscope */}
        <div style={{ display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: "20px" }}>
          <div style={inputContainerStyle}>
            <select style={inputStyle} value={logValues.calibrationChecks} onChange={(e) => setValue("calibrationChecks", e.target.value)}>
          ...
          <div style={inputContainerStyle}>
            <select style={inputStyle} value={logValues.electrodeCondition} onChange={(e) => setValue("electrodeCondition", e.target.value)}>
              <option>Clean</option>
              <option>Dirty</option>
          ...
          <div style={inputContainerStyle}>
            <select style={inputStyle} value={logValues.temperatureCompensation} onChange={(e) => setValue("temperatureCompensation", e.target.value)}>
          ...
          <div style={inputContainerStyle}>
            <input type="text" placeholder="Type Here" style={inputStyle} value={logValues.comments} onChange={(e) => setValue("comments", e.target.value)} />
            <label style={labelStyle}>Comments</label>
            <div style={rangeTextStyle}>{renderParameterInfo("Comments")}</div>
          </div>

          <div style={inputContainerStyle}>
            <select style={inputStyle} value={logValues.status} onChange={(e) => setValue("status", e.target.value)}>
              <option>Pass</option>
              <option>Fail</option>
            </select>
        ...
        <div style={{ display: "flex", alignItems: "center", gap: "24px", marginTop: "20px", fontSize: "14px" }}>
          ...
          <div style={{ marginLeft: "auto", display: "flex", gap: "12px" }}>
            ...
            <button onClick={handleSaveLogs} disabled={isSaving} style={{ padding: "10px 24px", backgroundColor: "#505050", color: "#fff", border: "none", borderRadius: "8px", fontSize: "14px", cursor: isSaving ? "not-allowed" : "pointer" }}>
        ...
        <div style={{ width: "100%", height: 300 }}>
          <ResponsiveContainer width="100%" height="100%">
            <BarChart data={activityData} stackOffset="sign" barGap={-25} margin={{ top: 20, right: 30, left: 45, bottom: 20 }}>
              ...
              <Tooltip cursor={{ fill: "transparent" }} formatter={(value: number, name: string) => [ Math.abs(value), name === "compliant" ? "Compliant" : "Non-Compliant" ]} /> 
