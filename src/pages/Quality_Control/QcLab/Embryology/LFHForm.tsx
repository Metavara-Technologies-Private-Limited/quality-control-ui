...
const LFHForm = ({ selectedRadio, setSelectedRadio }) => {
  ...
  // Common border style to match your image
  const sectionStyle = {
    backgroundColor: "#fff",
    borderRadius: "12px",
    border: "1px solid #e5e7eb",
    padding: "24px",
    marginBottom: "12px", // Gap between the two main boxes
  };

  return (
    <div style={{ maxWidth: "1200px" }}>
      
      {/* SECTION 1: Radio Buttons + Form Fields + Buttons */}
      <div style={sectionStyle}>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(280px, 1fr))", gap: "24px", marginBottom: "32px" }}>
          <div style={{ position: "relative" }}>
            <input type="text" placeholder="Type Here" value={formData.airflowVelocity} onChange={(e) => setFormData({ ...formData, airflowVelocity: e.target.value })} style={{ width: "100%", height:"50px", padding: "10px 12px", border: "1px solid #e5e7eb", borderRadius: "8px", fontSize: "14px", outline: "none", color: "#0f172a", backgroundColor: "#fff" }} />
          ...
          <div style={{ position: "relative" }}>
            <select value={formData.hepaFilterIntegrity} onChange={(e) => setFormData({ ...formData, hepaFilterIntegrity: e.target.value })} style={{ width: "100%", height:"50px", padding: "10px 12px", border: "1px solid #e5e7eb", borderRadius: "8px", fontSize: "14px", outline: "none", cursor: "pointer", backgroundColor: "#fff", color: "#0f172a" }}>
          ...
          <div style={{ position: "relative" }}>
            <select value={formData.uvLightFunctionality} onChange={(e) => setFormData({ ...formData, uvLightFunctionality: e.target.value })} style={{ width: "100%", height:"50px", padding: "10px 12px", border: "1px solid #e5e7eb", borderRadius: "8px", fontSize: "14px", outline: "none", cursor: "pointer", backgroundColor: "#fff", color: "#0f172a" }}>
        ...
        {/* Action Buttons inside the first section */}
        <div style={{ display: "flex", justifyContent: "flex-end", gap: "12px", flexWrap: "wrap", borderTop: "1px solid #f1f5f9", paddingTop: "24px" }}>
