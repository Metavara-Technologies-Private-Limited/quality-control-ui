...
const MicroscopesForm = ({ selectedRadio, setSelectedRadio }: any) => {
  // Activity data matching provided divergent bar chart
  const activityData = [
      ...
      <div style={{ backgroundColor: "#fff", borderRadius: "12px", border: "1px solid #e5e7eb", padding: "24px" }}>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: "20px" }}>
          <div style={inputContainerStyle}>
            <select style={inputStyle} defaultValue="Clean">
          ...
          <div style={inputContainerStyle}>
            <select style={inputStyle} defaultValue="Accurate">
