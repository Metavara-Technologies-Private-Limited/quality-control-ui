...
const MicroscopesForm = ({ selectedRadio, setSelectedRadio }) => {
  const [formData, setFormData] = useState({
    lensCleanliness: "Clean",
    lightSourceFunctionality: "Functional",
  ...
  const sectionStyle = {
    ...
    padding: "24px",
    marginBottom: "16px", // Gap between the two boxes
  };

  return (
    <div style={{ maxWidth: "1200px" }}>
      
      {/* SECTION 1: Radio Buttons, Fields, and Buttons */}
      <div style={sectionStyle}>
        ...
        >
          <div style={{ position: "relative" }}>
            <select
              value={formData.lensCleanliness}
              onChange={(e) => setFormData({ ...formData, lensCleanliness: e.target.value })}
          ...
          <div style={{ position: "relative" }}>
            <select
              value={formData.lightSourceFunctionality}
              onChange={(e) => setFormData({ ...formData, lightSourceFunctionality: e.target.value })}
              style={{ width: "100%", height: "50px", padding: "10px 12px", border: "1px solid #e5e7eb", borderRadius: "8px", fontSize: "14px", outline: "none", cursor: "pointer", backgroundColor: "#fff", color: "#0f172a" }}
            >
        ...
        {/* Buttons inside Section 1 */}
        <div style={{ display: "flex", justifyContent: "flex-end", gap: "12px", borderTop: "1px solid #f1f5f9", paddingTop: "24px" }}>
          <button onClick={handleClearForm} style={{ padding: "10px 24px", backgroundColor: "#fff", border: "1px solid #e5e7eb", borderRadius: "8px", fontSize: "14px", fontWeight: "500", cursor: "pointer", color: "#0f172a" }}>
            Clear
          </button>
          <button style={{ padding: "10px 24px", backgroundColor: "#1e293b", color: "#fff", border: "none", borderRadius: "8px", fontSize: "14px", fontWeight: "500", cursor: "pointer" }}>
            Save
          </button>
        </div>
      </div>
