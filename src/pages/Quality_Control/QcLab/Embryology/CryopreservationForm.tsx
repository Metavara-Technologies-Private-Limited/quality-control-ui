...
const CryopreservationForm = ({ selectedRadio, setSelectedRadio, equipmentDetails }: CryopreservationFormProps) => {
  ...
  const labelOverlayStyle = { position: "absolute" as const, left: "12px", top: "-8px", backgroundColor: "#fff", padding: "0 4px", fontSize: "14px",  color: "#232323" };
...
{ed.equipment_num}
        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: "20px" }}>
          ...
          <div style={inputContainerStyle("Liquid Nitrogen Levels (mm)")}>
            ...
            />
            <label style={{...labelOverlayStyle, fontSize: "13px"}}>Liquid Nitrogen Levels (mm)</label>
        ...
        <div style={{ display: "flex", alignItems: "center", gap: "24px", marginTop: "20px", fontSize: "14px" }}>
          ...
          <div style={{ marginLeft: "auto", display: "flex", gap: "12px" }}>
            <button onClick={handleClearForm} disabled={isSaving} style={{ padding: "10px 24px",fontSize: "14px",fontWeight: "700", backgroundColor: "#fff", border: "1px solid #505050", borderRadius: "8px", cursor: isSaving ? "not-allowed" : "pointer", opacity: isSaving ? 0.6 : 1 }}>Clear</button>
            <button onClick={handleSaveLogs} disabled={isSaving} style={{ padding: "10px 24px", backgroundColor: "#505050", color: "#FFFFFF", border: "none", borderRadius: "8px", cursor: isSaving ? "not-allowed" : "pointer", opacity: isSaving ? 0.7 : 1 }}>
