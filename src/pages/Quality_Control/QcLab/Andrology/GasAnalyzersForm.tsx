              ...
              >
                ...
                <div style={inputContainerStyle("Gas Mixture")}>
                  <input
                    ...
                    value={logValues["gasMixture"] || ""}
                    onChange={(e) => setValue("gasMixture", e.target.value)}
                    disabled={!getDbParam("Gas Mixture")}
                    style={{ ...getInputStyle("Gas Mixture"), display: "block" }}
                  />
                ...
                <div style={inputContainerStyle("Sensor Condition")}>
                  <select
                    ...
                    value={logValues["sensorCondition"] || "Good"}
                    onChange={(e) => setValue("sensorCondition", e.target.value)}
                    disabled={!getDbParam("Sensor Condition")}
                    style={{
                      ...getInputStyle("Sensor Condition"),
                      cursor: "pointer",
                    }}
                  >
                ...
                <div style={inputContainerStyle("Comments")}>
                  <input
                    ...
                    style={{ ...getInputStyle("Comments"), display: "block" }}
                  />
