...
const AddEnvParameterPopup: React.FC<Props> = ({
  open,
  onClose,
  onAdd,
  initialData,
  ...
  // In AddEnvParameterPopup.tsx - Update the validateForm function
  ...
  // In AddEnvParameterPopup.tsx - Update the handleSave function
...
export default AddEnvParameterPopup;
